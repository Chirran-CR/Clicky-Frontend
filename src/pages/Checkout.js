...
const Checkout = () => {
  ...
  const checkoutHandler = async () => {
    ...
    const result = await axios.post(
      "http://localhost:5000/api/user/order/checkout",{amount:totalAmount+5},config
    );
    if (!result) {
    ...
    const options = {
      key: "rzp_test_IUcaV8QKLrrH4s", // Enter the Key ID generated from the Dashboard
      amount: amount,
      currency: currency,
      name: "Chirran Com.",
      ...
      prefill: {
        name: "Chirran",
        email: "chirran@example.com",
        contact: "9999999999",
      },
      notes: {
        address: "Chirran's Corporate Office",
      },
      theme: {
        color: "#61dafb",
      },
